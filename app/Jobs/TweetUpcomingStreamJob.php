...
class TweetUpcomingStreamJob implements ShouldQueue
{
    ...
    public function handle(): void
    {
        ...
        app(Twitter::class)
            ->tweet("🔴 A new stream{$twitterHandleIfGiven}is about to start: {$this->stream->title}. Join in now!" . PHP_EOL . $this->stream->url());
