        ...
        <div class="w-full max-w-xl px-4 mx-auto sm:px-6 md:px-8">
            <div>
                ...
                <div class="mt-1 relative rounded-md shadow-sm">
                    ...
                    <input wire:model.debounce.300ms="search" type="search" name="search" id="search" class="text-gray-600 focus:ring-indigo-500 focus:border-indigo-500 block w-full pl-9 sm:text-sm border-gray-300 rounded-md" placeholder="Search">
                </div>
            </div>
        </div>
    @endif
